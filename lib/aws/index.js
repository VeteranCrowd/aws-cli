...
import { fixAutoscale } from './fixAutoscale.js';
...
import { removeAutoscale } from './removeAutoscale.js';
import { getAwsSsoCredentials } from './getAwsSsoCredentials.js';
import { createOrUpdateApiGatewayExecutionLog } from './apiGatewayLog.js';
...
export const aws = new Command()
  ...
  .addCommand(migrateData)
  .addCommand(pushAmplify)
  .addCommand(fixAutoscale)
  .addCommand(removeAutoscale)
  .addCommand(redrive)
  .addCommand(createOrUpdateApiGatewayExecutionLog);
